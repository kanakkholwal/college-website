    ...
    return (<>
        ...
        <main className="space-y-40 mb-40 max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            ...
            <section className="font-medium text-base space-y-4 text-slate-600 dark:text-slate-400">
                <p className="mb-3 mt-8">Welcome to <span className="font-bold">{process.env.NEXT_PUBLIC_WEBSITE_NAME}</span>! These terms outline the rules and regulations for the use of our website. By accessing this website, we assume you accept these terms and conditions. Do not continue to use {process.env.NEXT_PUBLIC_WEBSITE_NAME} if you do not agree to all the terms and conditions stated on this page.</p>
                ...
                <ul className="list-disc list-inside">
                    ...
                    <li>
                        "The Company", "Ourselves", "We", "Our", and "Us", refer to {process.env.NEXT_PUBLIC_WEBSITE_NAME}.
                ...
                <p>We employ the use of cookies. By accessing {process.env.NEXT_PUBLIC_WEBSITE_NAME}, you agreed to use cookies in agreement with the {process.env.NEXT_PUBLIC_WEBSITE_NAME}'s <Link href="/privacy" className="font-bold italic text-primary hover:underline">Privacy Policy</Link>.</p>
                <h4 className="mb-4 text-xl font-semibold leading-7 tracking-wide text-slate-700 dark:text-slate-200">License</h4>
                <p>Unless otherwise stated, {process.env.NEXT_PUBLIC_WEBSITE_NAME} and/or its licensors own the intellectual property rights for all material on {process.env.NEXT_PUBLIC_WEBSITE_NAME}. All intellectual property rights are reserved. You may access this from {process.env.NEXT_PUBLIC_WEBSITE_NAME} for your own personal use subjected to restrictions set in these terms and conditions.</p>
                ...
                <ul className="list-disc list-inside">
                    ...
                    <li>
                    Sell, rent, or sub-license material from {process.env.NEXT_PUBLIC_WEBSITE_NAME}
                    </li>
                    <li>
                    Reproduce, duplicate, or copy material from {process.env.NEXT_PUBLIC_WEBSITE_NAME}
                    </li>
                    <li>
